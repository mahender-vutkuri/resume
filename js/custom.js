document.addEventListener('DOMContentLoaded', function(){
  Typed.new('.intro-text', {
    strings: ["^600 Mahender Reddy.", "^600 a Front end Developer.", "^1000 a UI/UX Designer and Developer.", "^600 a Mobile app Developer."],
    typeSpeed: 0,
    startDelay: 1000,
    loop: true
  });
...
function init() {
    ...
    var mapOptions = {
        ...
        center: new google.maps.LatLng(17.4436, 78.4458), // New York
